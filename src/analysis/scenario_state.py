...
SCENARIOS: dict[str, dict] = {
    "base": {
        ...
        "calibration_note": "No adjustment. All scores reflect raw model output.",
    },
    "escalation": {
        "label":            "Escalation",
        ...
        "short_bias":       False,
        "assumption_basis": "manual scenario assumption",
        "calibration_note": "Multipliers are directional scaling assumptions; not statistically calibrated.",
    },
    "de_escalation": {
        "label":            "De-escalation",
