...
def page_about_heramb() -> None:
    ...
    with col_main:
        ...
        st.markdown(
            ...
            f"entire codebase, architecture, and all 14 dashboard pages."
            f"</span>"
            ...
            f"<li style='margin-bottom:4px;'><span class='ah-body'>"
            f"Architected a 7-agent AI orchestration pipeline (Risk Officer, Macro Strategist, "
            f"Geo Analyst, Commodities Specialist, Stress Engineer, Trade Structurer, CQO) with "
            ...
            f"<li style='margin-bottom:4px;'><span class='ah-body'>"
            f"Built the full data layer: yfinance multi-asset downloader (50+ tickers), "
            f"FRED API integration (14 macro series), real-time implied vol scraping "
            f"(VIX/OVX/GVZ/VVIX), and proactive alert engine</span></li>"
            f"<li style='margin-bottom:0;'><span class='ah-body'>"
            f"Designed all 14 pages end-to-end: Overview, Correlation, Spillover, "
            f"Macro Intelligence, Geopolitical Triggers, War Impact Map, Strait Watch, "
            f"Trade Ideas, Portfolio Stress Test, Scenario Engine, Commodities Watchlist, "
            f"Model Accuracy, Actionable Insights, and AI Chat</span></li>"
            f"</ul>"
            f"<div style='{_SROW}'>"
            f"<div style='{_SITM}background:#080808;'>"
            f"<span class='ah-num'>14</span>"
            f"<span class='ah-slbl'>Pages Built</span></div>"
            f"<div style='{_SITM}background:#080808;'>"
            f"<span class='ah-num'>7</span>"
            f"<span class='ah-slbl'>AI Agents</span></div>"
            f"<div style='{_SITM}background:#080808;'>"
            f"<span class='ah-num'>5</span>"
            f"<span class='ah-slbl'>Quant Models</span></div>"
            f"<div style='flex:1;text-align:center;padding:0.65rem 0.25rem;"
            f"background:#080808;'>"
            f"<span class='ah-num'>23K+</span>"
