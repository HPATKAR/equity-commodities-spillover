...
def page_about_heramb() -> None:
    ...
    with col_main:
        ...
        st.markdown(
            ...
            f"<p style='{_f}margin:0 0 10px 0;'>"
            "Lead developer and quantitative architect on the Equity-Commodities Spillover Monitor - "
            "Course Project 3 for Prof. Cinder Zhang's MGMT 69000-120.</p>"
            f"<ul style='{_f}margin:0 0 14px 0;padding-left:1.1rem'>"
            "<li style='margin-bottom:5px'>Designed and built the full Streamlit application: multi-page architecture, "
            "custom navbar, dark theme CSS design system, and all 14 dashboard pages</li>"
            "<li style='margin-bottom:5px'>Implemented the quantitative engine: Diebold-Yilmaz FEVD spillover, "
            "VAR/Granger causality, DCC-GARCH correlation, Markov regime detection, and transfer entropy</li>"
            "<li style='margin-bottom:5px'>Built the AI agent workforce: 8 specialized agents with a 4-round "
            "dependency-ordered orchestration pipeline, CQO quality auditing, and active remediation loop</li>"
            "<li style='margin-bottom:5px'>Developed the data layer: yfinance multi-asset downloader, FRED API "
            "integration (14 macro series), and real-time proactive alert engine</li>"
            "<li style='margin-bottom:0'>Built all 14 dashboard pages end-to-end as sole developer - "
            "Stress Test, Scenario Engine, Strait Watch, War Impact Map, Macro Dashboard, Insights, AI Chat, and more</li>"
            "</ul>"
            "<div class='stat-row'>"
            "<div class='stat-item'><p class='stat-num'>14</p><p class='stat-label'>Pages Built</p></div>"
            "<div class='stat-item'><p class='stat-num'>8</p><p class='stat-label'>AI Agents</p></div>"
            "<div class='stat-item'><p class='stat-num'>5</p><p class='stat-label'>Quant Models</p></div>"
            "<div class='stat-item'><p class='stat-num'>23K+</p><p class='stat-label'>Lines of Code</p></div>"
            "</div>"
            "</div>",
            unsafe_allow_html=True,
        )
