...
def page_about_ilian() -> None:
    ...
    with col_main:
        ...
        st.markdown(
            ...
            f"<p style='{_f}margin:0 0 10px 0;'>"
            "Geopolitical Research and Scenario Design contributor on the Equity-Commodities Spillover Monitor - "
            "Course Project 3 for Prof. Cinder Zhang's MGMT 69000-120.</p>"
            f"<ul style='{_f}margin:0 0 14px 0;padding-left:1.1rem'>"
            "<li style='margin-bottom:5px'>Designed the War Impact Map scoring framework: per-war baseline scores, "
            "country-level commodity exposure weights, and concurrent-war amplifier for Ukraine, Gaza/Red Sea, and Iran/Hormuz</li>"
            "<li style='margin-bottom:5px'>Authored all geopolitical event descriptions in the dashboard "
            "(13 events, 2008-2025) connecting conflict timelines to commodity and equity market impacts</li>"
            "<li style='margin-bottom:5px'>Built the Strait Watch framework: five critical maritime chokepoints, "
            "EIA/IEA throughput data, and disruption scoring methodology</li>"
            "<li style='margin-bottom:5px'>Researched the Iran/Hormuz escalation: oil and LNG regional exposure, "
            "energy-importing Asia risk, and Brent/WTI spread dynamics</li>"
            "<li style='margin-bottom:0'>Authored narrative content across the dashboard (page intros, takeaway blocks, "
            "section conclusions) connecting quantitative outputs to real-world market context</li>"
            "</ul>"
            "<div class='stat-row'>"
            "<div class='stat-item'><p class='stat-num'>13</p><p class='stat-label'>Events Catalogued</p></div>"
            "<div class='stat-item'><p class='stat-num'>5</p><p class='stat-label'>Chokepoints Mapped</p></div>"
            "<div class='stat-item'><p class='stat-num'>3</p><p class='stat-label'>Active Conflicts</p></div>"
            "<div class='stat-item'><p class='stat-num'>40+</p><p class='stat-label'>Countries Scored</p></div>"
            "</div>"
            "</div>",
            unsafe_allow_html=True,
        )
